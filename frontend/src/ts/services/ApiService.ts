...
export default class ApiService
{
    ...
    */
   private async query(request: Request, method: 'get' | 'post' | 'put' | 'patch' | 'delete'): Promise<ResponseResult> {
      try {
    ...
    * @returns The rendered response result
    */
   public get = async (request: GetRequest): Promise<ResponseResult> => await this.query(request, 'get');
    ...
    * @returns The rendered response result
    */
   public post = async (request: Request): Promise<ResponseResult> => await this.query(request, 'post');
    ...
    * @returns The rendered response result
    */
   public put = async (request: Request): Promise<ResponseResult> => await this.query(request, 'put');
    ...
    * @returns The rendered response result
    */
   public patch = async (request: Request): Promise<ResponseResult> => await this.query(request, 'patch');
    ...
    * @returns The rendered response result
    */
   public delete = async (request: GetRequest): Promise<ResponseResult> => await this.query(request, 'delete');

   public getFile = async (path: string, type: ResponseType): Promise<ResponseResult> => {
      try {
